...
import {
  ...
  COPY_PATH,
  SHOW_IN_FOLDER,
  TRANSFORM_PICTURE_BASE64,
  TRANSFORM_PICTURE_LOCAL,
  TRANSFORM_PICTURE_NETWORK
} from './menuItems'
...
export const showContextMenu = (event, tab) => {
  ...
  const { pathname } = tab
  const CONTEXT_ITEMS = [CLOSE_THIS, CLOSE_OTHERS, CLOSE_SAVED, CLOSE_ALL, SEPARATOR, RENAME, COPY_PATH, SHOW_IN_FOLDER, SEPARATOR, TRANSFORM_PICTURE_BASE64, TRANSFORM_PICTURE_LOCAL, TRANSFORM_PICTURE_NETWORK]
